---
title: "AT&T Wireless Internet MF279 External Antenna Guide"
source_url: "https://www.waveform.com/a/b/guides/hotspots/att-mf279"
guide_type: "router_external_antenna_guide"
---

# AT&T Wireless Internet MF279 External Antenna Guide
...
Looking to get the best possible data rates from your (ZTE) AT&T Wireless Internet MF279 hotspot?
...
In this guide
- The Best External Antennas For the AT&T Wireless Internet MF279
- Why External Antennas Are Critical for Improving Data Rates
- Positioning and Aiming MIMO Antennas
- AT&T Wireless Internet MF279 Technical Specifcations
...
The AT&T Wireless Internet MF279 has two SMA ports on the back, which allow for a 2x2 MIMO antenna to be connected to the device.

We recommend two different MIMO antenna options for use with the AT&T Wireless Internet hotspot:
...
For most users the best external antenna choice for the AT&T Wireless Internet MF279 is our MIMO panel antenna kit . This antenna doesn’t require line-of-sight to the tower.
...
However, if you have line of sight to the nearest tower , we recommend using a DualPlus MIMO log periodic antenna kit . The higher gain on these antennas can get you better performance, but only when you have a straight shot to the tower.
...
Hotspots like the AT&T Wireless Internet MF279 support an LTE feature called "carrier aggregation."

Carrier aggregation allows the AT&T hotspot to connect on multiple cellular bands simultaneously.
...
Positioning and Aiming MIMO Antennas
Positioning and aiming MIMO antennas well is crucial to getting the best performance to your AT&T Wireless Internet MF279, or indeed any other hotspot.
...
The goal is to find the best location and direction for the antenna(s), to maximize data rates to the AT&T Wireless Internet hotspot. It can take a little patience, but can have a huge impact – it’s worth a bit of extra effort!

Before getting started, it's always a good idea to run a couple of speed tests indoors from a device connected to your AT&T hotspot's. The results will fluctuate a little, but this is the baseline you're trying to improve.

SMA ports on the AT&T Wireless Internet MF279

Now connect the MIMO antennas to your AT&T Wireless Internet MF279 via the SMA ports, like in the image above, and go outside with your "test-rig".
...
Once you've found the position which gets you the highest data rates to the AT&T Wireless Internet hotspot, that's where you'll want to install the MIMO antenna. Go ahead and mount the antenna, run cables inside, connect everything up, and enjoy superior data rates!

AT&T Wireless Internet MF279 Technical Specifcations
Supported 4G LTE bands in the US

- AT&T: B2, B4, B5, B12, B17, B29, B30, B14 , B46

- Verizon: B2, B4, B5, B13 , B66

- T-Mobile: B2, B4, B5, B12, B41 , B25 , B26 , B66 , B71

Cellular Modem

- Model: ZTE MF279

- MIMO Support: 2x2 w/ internal antennas, 2x2 w/ external antennas

- LTE Performance Category: Cat 16

Wi-Fi

- Technologies: 802.11 n/ac
...
- Other Ports: Gigabit Ethernet; analog phone jack

Other Helpful Resources
AT&T Wireless Internet (MF279) Support Page

- AT&T WIRELESS INTERNET (MF279) Device help
