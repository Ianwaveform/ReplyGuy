---
title: "Verizon Jetpack MiFi 8800L External Antenna Guide"
source_url: "https://www.waveform.com/a/b/guides/hotspots/jetpack-8800L"
guide_type: "router_external_antenna_guide"
---

# Verizon Jetpack MiFi 8800L External Antenna Guide
...
Looking to get the best possible data rates from your Verizon Jetpack 8800L?
...
- Show where the TS9 ports are located on the MiFi device.

- Explain how to aim the antennas for best results.

In this guide
- The Best External Antennas For the Verizon Jetpack MiFi 8800L
- Why External Antennas Are Critical for Improving Data Rates
- Positioning and Aiming MIMO Antennas
- Verizon Jetpack MiFi 8800L Technical Specifications
...
The Verizon Jetpack 8800L has two TS9 ports on the bottom, covered by little grey caps. These allow for a 2x2 MIMO antenna to be connected to the device.

We recommend two different MIMO antenna options for use with the Verizon Jetpack MiFi 8800L:

Best For Most Users

MIMO Panel Antenna Kit
...
For most users the best external antenna choice for the Verizon Jetpack MiFi 8800L is our 2x2 MIMO panel antenna kit . This antenna doesn’t require line-of-sight to the tower.
...
Hotspots like the Jetpack 8800L support an LTE feature called "carrier aggregation."

Carrier aggregation allows the Jetpack 8800L to connect on multiple cellular bands simultaneously.
...
Positioning and Aiming MIMO Antennas
Positioning and aiming MIMO antennas well is crucial to getting the best performance to your Verizon Jetpack MiFi 8800L, or indeed any other hotspot.
...
The goal is to find the best location and direction for the antenna(s), to maximize data rates to the Jetpack. It can take a little patience, but can have a huge impact – it’s worth a bit of extra effort!

Before getting started, it's always a good idea to run a couple of speed tests indoors from a device connected to your Jetpack's WiFi. The results will fluctuate a little, but this is the baseline you're trying to improve.

TS9 adapters connected to the Verizon Jetpack 8800L

Now connect the MIMO antennas to your Verizon Jetpack MiFi 8800L via the TS-9 ports, and go outside with your "test-rig".
...
Once you've found the position which gets you the highest data rates to the Jetpack, that's where you'll want to install the MIMO antenna. Go ahead and mount the antenna, run cables inside, connect everything up, and enjoy superior data rates!
...
- AT&T: B2, B4, B5, B14, B66, B12 , B17 , B29 , B30

- T-Mobile: B2, B4, B5, B66, B41 , B25 , B26 , B71 , B12

Cellular Modem

- Model: Qualcomm Snapdragon X20

- MIMO Support: 4X4 w/ internal antennas, 2x2 w/ external antennas

- LTE-A Carrier Aggregation: Yes, including LAA (5x 20 Mhz bands)

- LTE Performance Category: Cat 18

- Max Theoretical Speeds: 1,200Mbps Download, 150Mbps Upload

Wi-Fi

- Technologies: 802.11 b/g/n/a/ac

- Bands: Simultaneous 2.4 GHz and 5.8 GHz

Ports

- Cellular Antenna Ports: Dual TS-9

- Other Ports: USB-C (power)
...
Verizon's support page for the Jetpack 8800L

- Verizon Jetpack MiFi 8800L - Support Overview
